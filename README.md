...
anyways, has decent support, e.g. implementing interfaces, extending classes.
...
* If you dont follow the formats things will break.
...
|----------|-------|-------------|
| Default  | d     | If you have this it adds accessors, mutators and places definitions inside
of the NON default constructor params as well as calls their respective mutators. |
| Final    | f     | This makes the variable final and adds a default value, see `Final Note`. |
